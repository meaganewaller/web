...
const Navbar = () => {
  ...
  const [isDropdownOpen, setIsDropdownOpen] = useState(updatedIsDropdownOpen as boolean[]);
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl p-3 md:flex md:justify-between md:px-4 md:py-3.5">
        ...
        {showToggleTheme && (
          <div
            className={`${isToggleMenuOpen ? 'block' : 'hidden'} fixed bottom-0 left-0 w-full justify-end p-3 md:static md:mb-0 md:flex md:w-auto md:self-center md:p-0`}
          >
