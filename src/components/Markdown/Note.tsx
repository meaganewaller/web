...
const NoteTitle = styled.span(({ type }: { type: string }) => [
  ...
  type === "info" && tw`border-blue-500 text-blue-500 dark:border-blue-300 dark:text-blue-300`,
  type === "warning" && tw`border-yellow-500 text-yellow-500 dark:border-yellow-300 dark:text-yellow-300`,
  type === "error" && tw`border-red-500 text-red-500 dark:border-red-300 dark:text-red-300`,
  type === "success" && tw`border-green-500 text-green-500 dark:border-green-300 dark:text-green-300`,
])
