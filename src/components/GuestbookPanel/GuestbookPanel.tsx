...
const GuestbookPanel = ({ onSendMessage }: GuestbookPanelProps) => {
  ...
  return (
    ...
    >
      <m.h2 className={cn('text-2xl font-bold text-center py-4 font-monoItalic text-pink-500')}>Leave a message</m.h2>
      <form className={cn('px-8 pt-6 pb-8 mb-4 rounded')} onSubmit={handleSubmit}>
        <div className={cn('mb-4 md:flex md:flex-col md:justify-between')}>
          <div className="flex flex-col gap-4">
            <div className={cn('flex w-full mb-4 md:mr-2 md:mb-0 gap-x-4')}>
              <Input
                type="text"
                placeholder="Name"
                ref={nameInput}
