...
export default async function Landing() {
  ...
  return (
    <main className="grid-areas-landingMobile md:grid-areas-landing grid-cols-landing grid max-w-full grid-flow-row flex-col gap-2 p-2 text-gray-950 dark:text-gray-50">
