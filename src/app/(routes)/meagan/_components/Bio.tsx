...
export function Bio() {
  return (
    <div className='mt-[2rem] flex flex-col'>
      <h1 className="font-extra px-5 pb-1 pt-5 text-center text-lg uppercase tracking-wide before:pr-[5px] before:content-[url('/images/ui/leftsparkle.gif')] after:pl-[5px] after:content-[url('/images/ui/leftsparkle.gif')]">
        A Bit More
      </h1>
