...
export function Bio() {
  return (
    <div className="mt-[2rem] flex flex-col">
      <h1 className="font-pixel px-5 pb-1 pt-5 text-center text-lg uppercase tracking-wide text-violet-600 dark:text-yellow-400 before:pr-[5px] before:content-[url('/images/ui/leftsparkle.gif')] after:pl-[5px] after:content-[url('/images/ui/rightsparkle.gif')]">
        A Bit More
      </h1>
      <p className="text-lg px-5 py-4 ">
        <strong>
      ...
      <p className="text-lg px-5 py-4 break-words">
        ...
        course titled College Success (twice).
      </p>
      <p className="text-xl px-5 py-4 mx-auto">
        <Link href="/talks">I&apos;ve talked about that experience a lot.</Link>
      </p>
      <p className="text-lg px-5 py-4">
      ...
      <p className="text-lg px-5 py-4 ">
        ...
        <Link href="https://www.google.com/shopping/product/8474171075434410350?q=best+books+to+learn+python&prds=epd:10388856195847163316,prmr:3,eto:10388856195847163316_1,rto:1,tpim:CLi-yo_KrtzkTxD65b2x5pCKqw8YkODWCyIDVVNEKPD0if8FMNzrxEM">
      ...
      <p className="text-lg px-5 py-4 ">
        I applied with <Link href="https://github.com/meaganewaller/tic-tac-toe">this unbeatable Tic-Tac-Toe game</Link>
      ...
      <p className="text-lg px-5 py-4 ">
        ...
        <Link href="https://www.goodreads.com/user/show/3168826-meagan-waller">love to read</Link>, cook, and I want to
        say I&apos;m a plant lover, but I don&apos;t know if you&apos;re supposed to be continually bringing things to
        the brink of death if you love them.
      </p>
      <p className="text-lg px-5 py-4 ">
        I live in a historic neighborhood in Jacksonville, FL, with my husband and our two dogs.
      </p>
    </div>
  )
}
