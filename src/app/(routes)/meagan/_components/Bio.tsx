...
export function Bio() {
  return (
    <div className="mt-[2rem] flex flex-col">
      <h1 className="font-pixel px-5 pb-1 pt-5 text-center text-lg uppercase tracking-wide text-primary-600 before:pr-[5px] before:content-[url('/images/ui/leftsparkle.gif')] after:pl-[5px] after:content-[url('/images/ui/rightsparkle.gif')]">
        A Bit More
      </h1>
      <p className="text-lg px-5 py-4 text-justify md:px-20">
        <strong>
      ...
      <p className="text-lg px-5 py-4 text-justify md:px-20">
        ...
        course titled College Success (twice). I&apos;ve <Link path="/talks" label="talked about that experience a lot" />.
      </p>
      <p className="text-lg px-5 py-4 text-justify md:px-20">
      ...
      <p className="text-lg px-5 py-4 text-justify md:px-20">
        ...
        <Link
          path="https://www.google.com/shopping/product/8474171075434410350?q=best+books+to+learn+python&prds=epd:10388856195847163316,prmr:3,eto:10388856195847163316_1,rto:1,tpim:CLi-yo_KrtzkTxD65b2x5pCKqw8YkODWCyIDVVNEKPD0if8FMNzrxEM"
          label="Python Programming for the Absolute Beginner."
        />{' '}I chose Python because it was the only language in the bookstore with a book geared towards beginners.
      </p>
      <p className="text-lg px-5 py-4 text-justify md:px-20">
        I applied with{' '}
        <Link
          path="https://github.com/meaganewaller/tic-tac-toe"
          label="this unbeatable Tic-Tac-Toe game"
        />
      ...
      <p className="text-lg px-5 py-4 text-justify md:px-20">
        ...
        <Link
          path="https://www.goodreads.com/user/show/3168826-meagan-waller"
          label="love to read"
        />
